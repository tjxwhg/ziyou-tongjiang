        ...
        solutions.forEach((sol, idx) => {
            ...
            html += `
                <div class="card-modern">
                    ...
                    <button class="btn btn-sm btn-outline-custom mt-2" onclick="window.viewTripSolution('${sol.id}')"><i class="fas fa-eye"></i> 查看详情</button>
                </div>
            `;
        });
    ...
    try {
        ...
        for (let id of merchantIds) {
            try {
                ...
                merchantMap[id] = await getMerchant(id);
...
export async function saveUserPreferencesToAPI(prefs) {
    try {
