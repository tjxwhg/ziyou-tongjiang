...
/**
 * 保存用户偏好（供 index.html 和 trip-planner 调用）
 * @param {Object} prefs - { user_id, preferred_categories, cuisine_prefs, pace }
 */
...
// 兼容旧命名，但推荐使用 saveUserPreferences
export { saveUserPreferences as saveUserPreferencesToAPI };
